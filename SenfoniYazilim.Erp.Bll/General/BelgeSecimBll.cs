...
{
    public class BelgeSecimBll : BaseHareketBll<OdemeBilgileri, SenfoniErpContext>
    {
            ...
            return List(filter, x => new
            {
                ...
                Toplamlar = x.MakbuzHareketleri.GroupBy(y => y.OdemeBilgileriId).DefaultIfEmpty().Select(y => new
                {
                    ...
                    SonIslemYeri = y.OrderByDescending(z => z.Id).Select(z => z.Makbuz.AvukatHesapId != null ? z.Makbuz.AvukatHesap.AdiSoyadi : z.Makbuz.BankaHesapId != null ? z.Makbuz.BankaHesap.HesapAdi : z.Makbuz.CariHesapId != null ? z.Makbuz.CariHesap.CariAdi : z.Makbuz.KasaHesapId != null ? z.Makbuz.KasaHesap.KasaAdi : z.Makbuz.SubeHesapId != null ? z.Makbuz.SubeHesap.SubeAdi : null).FirstOrDefault(),
                            ...
                            makbuzTuru == MakbuzTuru.AvukataGonderme ? (y.Toplamlar.BelgeDurumu == BelgeDurumu.KarsiliksizOlarakIsaretleme || y.Toplamlar.BelgeDurumu == BelgeDurumu.PortfoyeKarsiliksizIade) && (y.OdemeBilgileri.OdemeTipi == OdemeTipi.Acik || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Cek || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Senet || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Elden) :
                            ...
                            makbuzTuru == MakbuzTuru.BankayaTahsileGonderme || makbuzTuru == MakbuzTuru.CiroEtme ? (y.Toplamlar.BelgeDurumu == BelgeDurumu.Portfoyde || y.Toplamlar.BelgeDurumu == BelgeDurumu.PotfoyeGeriIade) && (y.OdemeBilgileri.OdemeTipi == OdemeTipi.Cek || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Senet) :
                            makbuzTuru == MakbuzTuru.BaskaSubeyeGonderme ? (y.Toplamlar.BelgeDurumu == BelgeDurumu.Portfoyde || y.Toplamlar.BelgeDurumu == BelgeDurumu.PotfoyeGeriIade || y.Toplamlar.BelgeDurumu == BelgeDurumu.PortfoyeKarsiliksizIade || y.Toplamlar.BelgeDurumu == BelgeDurumu.KarsiliksizOlarakIsaretleme || y.Toplamlar.BelgeDurumu == BelgeDurumu.KismiTahsilEdildi) && (y.OdemeBilgileri.OdemeTipi == OdemeTipi.Acik || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Cek || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Senet || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Elden) :
                            ...
                            makbuzTuru == MakbuzTuru.KarsiliksizOlarakIsaretleme ? (y.Toplamlar.BelgeDurumu == BelgeDurumu.Portfoyde || y.Toplamlar.BelgeDurumu == BelgeDurumu.KismiTahsilEdildi || y.Toplamlar.BelgeDurumu == BelgeDurumu.PotfoyeGeriIade) && (y.OdemeBilgileri.OdemeTipi == OdemeTipi.Acik || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Cek || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Senet || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Elden) :
                            makbuzTuru == MakbuzTuru.MahsupEtme ? (y.Toplamlar.BelgeDurumu == BelgeDurumu.Portfoyde || y.Toplamlar.BelgeDurumu == BelgeDurumu.KismiTahsilEdildi || y.Toplamlar.BelgeDurumu == BelgeDurumu.PotfoyeGeriIade || y.Toplamlar.BelgeDurumu == BelgeDurumu.PortfoyeKarsiliksizIade || y.Toplamlar.BelgeDurumu == BelgeDurumu.KarsiliksizOlarakIsaretleme) && (y.OdemeBilgileri.OdemeTipi == OdemeTipi.Acik || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Cek || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Senet || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Elden) :
                            makbuzTuru == MakbuzTuru.MusteriyeGeriIade ? y.Toplamlar.BelgeDurumu == BelgeDurumu.Portfoyde || y.Toplamlar.BelgeDurumu == BelgeDurumu.KismiTahsilEdildi || y.Toplamlar.BelgeDurumu == BelgeDurumu.PotfoyeGeriIade || y.Toplamlar.BelgeDurumu == BelgeDurumu.PortfoyeKarsiliksizIade || y.Toplamlar.BelgeDurumu == BelgeDurumu.KarsiliksizOlarakIsaretleme :
                            ...
                            makbuzTuru == MakbuzTuru.PortfoyeKarsiliksizIade ? (y.Toplamlar.BelgeDurumu == BelgeDurumu.CiroEtme || y.Toplamlar.BelgeDurumu == BelgeDurumu.AvukatYoluylaTahsilEtme || y.Toplamlar.BelgeDurumu == BelgeDurumu.KismiAvukatYoluylaTahsilEtme || y.Toplamlar.BelgeDurumu == BelgeDurumu.BankayaTahsileGonderme) && y.Toplamlar.HesapTuru == hesapTuru && y.Toplamlar.SonHesapId == hesapId :
                            makbuzTuru == MakbuzTuru.TahsilEtmeKasa || makbuzTuru == MakbuzTuru.TahsilEtmeBanka ? (y.Toplamlar.BelgeDurumu == BelgeDurumu.KarsiliksizOlarakIsaretleme || y.Toplamlar.BelgeDurumu == BelgeDurumu.KismiTahsilEdildi || y.Toplamlar.BelgeDurumu == BelgeDurumu.Portfoyde || y.Toplamlar.BelgeDurumu == BelgeDurumu.PotfoyeGeriIade || y.Toplamlar.BelgeDurumu == BelgeDurumu.PortfoyeKarsiliksizIade) && (y.OdemeBilgileri.OdemeTipi == OdemeTipi.Acik || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Senet || y.OdemeBilgileri.OdemeTipi == OdemeTipi.Elden) :
                            makbuzTuru == MakbuzTuru.TahsiliImkansizHaleGelme ? y.Toplamlar.BelgeDurumu == BelgeDurumu.KarsiliksizOlarakIsaretleme || y.Toplamlar.BelgeDurumu == BelgeDurumu.PortfoyeKarsiliksizIade || y.Toplamlar.BelgeDurumu == BelgeDurumu.PotfoyeGeriIade :
                        ...
                        ).Select(x => new BelgeSecimL
                        {
                            ...
                            BelgeDurum=x.Toplamlar.BelgeDurumu,
