...
{
    public class PurchaseWayBillItemsBll : BaseHareketBll<PurchaseWayBillItems, SenfoniErpContext>, IBaseHareketSelectBll<PurchaseWayBillItems>
    {
        public IEnumerable<BaseHareketEntity> List(Expression<Func<PurchaseWayBillItems, bool>> filter)
        {
            ...
            }).Select(x => new PurchaseWayBillItemsL
            {
                Id = x.wayBillItem.Id,
                WayBillId=x.wayBillItem.WayBillId,
                CompanyId = x.wayBillItem.CompanyId,
                PurchaseOfferItemId = x.wayBillItem.PurchaseOfferItemId,
                PurchaseOrderItemId = x.wayBillItem.PurchaseOrderItemId,
                ...
                IsOfferCancel = x.wayBillItem.IsOfferCancel,
                IsOfferActive = x.wayBillItem.IsOfferActive,
                IsOffferLocked = x.wayBillItem.IsOffferLocked,
