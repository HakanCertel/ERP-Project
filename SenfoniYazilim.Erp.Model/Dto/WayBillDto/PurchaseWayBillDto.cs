...
{
    [NotMapped]
    public class PurchaseWayBillS : PurchaseWayBill
    {
        ...
        public WayBillCreatingMethod PurchaseWayBillCreatingMethod { get; set; } = WayBillCreatingMethod.ChooseMaterial;
    }
    [NotMapped]
    public class PurchaseWayBillL : BaseEntity
    {
