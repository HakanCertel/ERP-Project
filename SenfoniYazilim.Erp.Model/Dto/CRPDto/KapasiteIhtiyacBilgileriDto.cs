...
{
    [NotMapped]
    public class KapasiteIhtiyacBilgileriL : KapasiteIhtiyacBilgileri, IBaseHareketEntity,IBaseEntityFilter
    {
    ...
    //[NotMapped]
    //public class MrpMalzemeIhtiyacBilgileriLL : MalzemeIhtiyacBilgileri, IBaseHareketEntity
    //{
    ...
    //}
    //[NotMapped]
    //public class MrpMalzemeIhtiyacBilgileriBirlestirLL : BaseEntity,IBaseHareketEntity
    //{
    //    public long MrpId { get; set; }
    //    public string MrpKod { get; set; }
    //    public string AnaReceteKodu { get; set; }
