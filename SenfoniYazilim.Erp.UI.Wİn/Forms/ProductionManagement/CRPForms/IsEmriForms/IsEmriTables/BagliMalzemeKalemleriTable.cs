...
{
    public partial class BagliMalzemeKalemleriTable : BaseTablo
    {
        ...
        public BagliMalzemeKalemleriTable()
        {
            InitializeComponent();
        ...
        protected internal override bool HatalıGiriş()
        {
            ...
            for (int i = 0; i < tablo.DataRowCount; i++)
            {
                ...
                {
                    tablo.FocusedRowHandle = i;
                    tablo.FocusedColumn = colNetIhtiyac;
                    tablo.SetColumnError(colNetIhtiyac, "Miktar Alanına Geçerli Bir Değer Giriniz .");
                }
        ...
        protected override void LookUpEdit_EditValueChanged(object sender, EventArgs e)
        {
            ...
            if (((LookUpEdit)sender).Name == repositoryItemLookUpDepo.Name)
            {
