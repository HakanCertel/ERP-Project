...
{
    public partial class ProductionDemandTable : BaseTablo
    {
        public ProductionDemandTable()
        {
            InitializeComponent();
        ...
        {
            var editForm = (ProductionDemandEditForm)OwnerForm;

            repositoryItemDate.MinValue = ((ProductionDemandEditForm)OwnerForm).txtIslemTarihi.DateTime;
        ...
        {
            if (Messages.SilMesaj("Ürün Talep Kartı") != System.Windows.Forms.DialogResult.Yes) return false;

            if (((ProductionDemandEditForm)OwnerForm).BaseIslemTuru != IslemTuru.EntityInsert)
            {
        ...
        protected internal override bool HatalıGiriş()
        {
            ...
            for (int i = 0; i < tablo.DataRowCount; i++)
            {
                ...
                if (entity.Quantity <= 0)
                {
                    ...
                    tablo.SetColumnError(colQuantity, "Ürün Talep İçin Girilecek Miktar Sıfıra Eşit Yada Sıfırdan Küçük Olamaz.");
                }
