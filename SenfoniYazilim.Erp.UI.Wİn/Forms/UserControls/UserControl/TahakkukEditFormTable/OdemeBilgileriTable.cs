...
namespace SenfoniYazilim.Erp.UI.Wİn.Forms.UserControls.UserControl.TahakkukEditFormTable
{
    public partial class OdemeBilgileriTable : BaseTablo
    {
        ...
        protected override void HareketEkle()
        {
            ...
            if (!ShowEditForms<TopluOdemePlaniEditForm>.ShowDialogForm(source, OwnerForm.Id, BakiyeHesapla(), ((TahakkukEditForm)OwnerForm).txtKayitTarihi.DateTime.Date, dahaOnceGirilenTaksitSayisi)) return;
